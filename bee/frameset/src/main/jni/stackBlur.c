...
Others:         NULL
*************************************************/
int *blur_ARGB_8888(int *pix,int width,int eight,int radius){
    int wm = width - 1;
    int hm = eight - 1;
    int wh = width * eight;
    ...
    int *vmin = (int *) malloc(MAX(width, eight) * sizeof(int));
...
short *blur_RGB_565(short *pix,int width,int height,int radius){
    int wm = width - 1;
    int hm = height - 1;
    int wh = width * height;
    int div = radius + radius + 1;
