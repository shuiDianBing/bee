package com.stynet.shuidianbing.opticalcharacterrecognition.zbar;
 ...
 * Android进阶 - 二维码生成 https://www.jianshu.com/p/b275e818de6a
 * Android进阶 - 二维码生成（花式效果）https://www.jianshu.com/p/c75f16de1b2c
 * 暂时没找到zbar生成二维码
 */
public class CreateQRcode {
     ...
     */
    @Nullable
    private Bitmap createQRCodeBitmap(@Nullable String content, int size, @Nullable String character_set, @Nullable String error_correction, @Nullable String margin,
                                            @ColorInt int color_black, @ColorInt int color_white, @Nullable Bitmap targetBitmap, @Nullable Bitmap logoBitmap, float logoPercent){
        /** 1.参数合法性判断 */
